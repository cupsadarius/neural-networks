class Population {
  constructor(agent, context, size, crossoverRate, mutationRate, layerMutationRate, nodeMutationRate) {
    this.best = null;
    this.mutationRate = mutationRate;
    this.layerMutationRate = layerMutationRate || 0;
    this.nodeMutationRate =  nodeMutationRate || 0;
  ...
  generate() {
    ...
    for (let index in this.population) {
      ...
      population[index] = this.agent
        ...
        .mutate(this.mutationRate, this.layerMutationRate, this.nodeMutationRate);
